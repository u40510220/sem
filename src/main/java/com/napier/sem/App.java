...
public class App
{
    ...
    public static void main(String[] args)
    {
        ...
        if (a == 26) {
            while (!validInput) {
                System.out.println("""
                        ...
                        7) Language report
                        Enter the report number here:""");
                //numbers for reports above are from 31 to 37
        ...
        //TODO if possible city validation within database
        ...
        validInput = false;
        if (a == 4|| a == 5|| a == 6|| a == 12| a == 13|| a == 14|| a == 15|| a == 16|| a == 20|| a == 21|| a == 22){
            while(!validInput) {
                System.out.println("How many results from the top would you like to get(number > 0): ");
    ...
    public Report getReport(int ID, String territory,int topFilter )
    {
        //TODO implement correct script creation OR generate reports and save them in organised way
        try
        {
